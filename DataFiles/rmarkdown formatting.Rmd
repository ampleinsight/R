...
---
#Install Latek so can export as PDF later
install.packages('tinytex')
tinytex::install_tinytex ()

AHMED KHAN: I JUST INSTALLED THE KNITR PACKAGE FROM THE "PACKAGES" MENU
...
If you want text to like `verbatim code` you should surround it with one backtick on both sides. (Verbtim code looks like R Code)

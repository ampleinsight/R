...
fig <- ggplotly(p)
#ggplotly adds interactive features. Hover and you see labels. Can also zoom and move figure now :). Can do this with almost any ggplot.
...
##Animation above is pretty jumpy -- so let's smooth out using object constancy
...
#Save as Web Page (HTML) and it'll retain the interactive features
